    ...
    <div class="a4-container">
        ...
        <section style="height: 40px; margin-top: 15px;">
            <div style="width: 95%; margin: auto">
                <div style="width: 46%; margin: auto; border: 1px solid #444; padding: 5px; border-radius: 7px; float:left">
                    <strong style="font-size: 15px">Bulletin N° </strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span style="color: red; font-size: 20px">{{ $contrat->numBullettin ?? ''}}</span>
                </div>

                <div style="width: 46%; margin: auto; border: 1px solid #444; padding: 5px; border-radius: 7px; float:right">
            ...
            <div class="content1" style="margin-top: 5px; padding: 10px;">
                ...
                <section style="width: 97%; margin: 5px 0; padding: 7px; border-radius: 7px;">
                    ...
                    <div style="width: 100%;">
                        ...
                        <div style="width: 33%; float: left;"><input type="radio" class="radio1" @if(isset($contrat->beneficiaireauterme) && $contrat->beneficiaireauterme == 'enfants' || $contrat->beneficiaireaudeces == 'conjoint;enfants' || $contrat->beneficiaireaudeces == 'enfants;conjoint') checked @endif ><span>Les enfants
                ...
                <section style="width: 97%; margin: 5px 0; padding: 7px; border-radius: 7px;">
                    ...
                    <div style="width: 100%;">
                        ...
                        <div style="width: 43%; float: left;"><input type="radio" class="radio1" @if(isset($contrat->beneficiaireaudeces) && $contrat->beneficiaireaudeces == 'conjoint') checked @endif><span>Le Conjoint
                                non séparé de corps, ni divorcé</span></div>
                        <div style="width: 33%; float: left;"><input type="radio" class="radio1" @if(isset($contrat->beneficiaireaudeces) && $contrat->beneficiaireaudeces == 'enfants' || $contrat->beneficiaireaudeces == 'conjoint;enfants' || $contrat->beneficiaireaudeces == 'enfants;conjoint') checked @endif><span>Les
        ...
        <section style="width: 100%; margin-top: 20px;">
            ...
            <div style="width: 100%; text-align: center;">
                <div style="width: 45%; float: left;">
                    ...
                    {{-- <img src="{{ $qrCodeBase64 }}" alt="QR Code" style="width: 60px; height: 60px;"> --}}
                    ...
                    <div style="width: 100%;">
                        ...
                        <div style="width: 50%; float: right;">
                            @if ($imageSrc != null)
                                <img src="{{ $imageSrc }}" alt="SIGN" style="width: 55px; height: 55px;">
                            @endif
                        </div>
