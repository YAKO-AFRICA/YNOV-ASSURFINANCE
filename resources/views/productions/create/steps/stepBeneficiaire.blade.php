<div id="test-l-3" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger3">
        ...
        <div class="col-12 col-lg-6">
            ...
            <div class="card" style="width: 80%">
                <div class="card-body">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="enfants" id="enfants">
        ...
        <div class="col-12 col-lg-6">
            ...
            <div class="card" style="width: 80%">
                <div class="card-body">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="enfants" id="enfants2" name="audecesContrat">
            ...
            <div class="d-flex align-items-center justify-content-between gap-3">
                <button onclick="event.preventDefault(); stepper1.previous()"
                    class="btn border-btn btn-previous-form"><i
                        class='bx bx-left-arrow-alt'></i>Précedent</button>
    ...
    <script>
        ...
        function addBeneficiaryRow() {
            ...
            const lieuNaissance = document.getElementById('lieunaissance') ? document.getElementById('lieunaissance').value : 'Choisir';
