            ...
            <table class="table mb-0" id="example2">
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        <td>{{ $item->assures->first()->nom ?? "" }} {{ $item->assures->first()->prenom ?? "" }}</td>
                        <td>{{ $item->assures->first()?->datenaissance ? \Carbon\Carbon::parse($item->assures->first()->datenaissance)->format('d-m-Y') : '' }}</td>
                        <td>{{ $item->assures->first()->lieuresidence ?? '' }}</td>
                        <td>{{ $item->assures->first()->profession ?? '' }}</td>
                        <td>{{ $item->assures->first()->mobile ?? '' }}</td>
                        <td>{{ $item->libelleproduit ?? "" }}</td>
                        <td>{{ $item->dateeffet ? \Carbon\Carbon::parse($item->dateeffet)->format('d-m-Y') : '' }}</td>
                        <td>{{ $item->prime ?? "" }}</td>
                        <td>{{ $item->capital ?? "" }}</td>
