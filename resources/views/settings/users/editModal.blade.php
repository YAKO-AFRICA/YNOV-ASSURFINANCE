                            ...
                            <fieldset class="border p-3" style="width: 100%;">
                                ...
                                <div class="row">
                                    <div class="mb-3 col-sm-12 col-md-6">
                                        ...
                                        <input type="text" value="ASSFIN"  name="codereseau" id="codereseau" class="form-control" readonly>
                                    </div>
                                    <div class="mb-3 col-sm-12 col-md-6">
                                    ...
                                    <div class="mb-3 col-sm-12 col-md-6">
                                        ...
                                        <select name="codeequipe" id="codeequipe" class="form-select">
                                            <option value="{{ $item->codeequipe }}">{{ $item->codeequipe ?? '' }}</option>
                                            @foreach ($agenceByReseeau as $equipe)
                                                <option class="form-control" value="{{ $equipe['CodeUnite'] }}">{{ $equipe['MonLibelle'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="mb-3 col-sm-12 col-md-6">
                                        <label for="codePart" class="form-label">Partenaire</label>
                                        <input type="text" name="codePart" class="form-control" value="ASSFIN" readonly disabled>
                                    </div>
                                </div>
                        ...
                        <div id="step-group-3" class="step-edit d-none">
                            <fieldset class="border p-3" style="width: 100%;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="branche" class="form-control" value="AGTGLE" readonly>
